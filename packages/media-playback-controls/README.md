...
```bash
pnpm add @cxing/media-playback-controls
```
...
```ts
import { createControls } from '@cxing/media-playback-controls';
...
Only the utility functions below are exported from `@cxing/media-playback-controls`.
